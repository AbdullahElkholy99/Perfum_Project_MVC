...
namespace Perfum.Repositories.Data.Migrations
{
    ...
    [Migration("20260308125403_AddEmailConfirmationCode")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Perfum.Domain.Models.Orders.ShippingAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Perfum.Domain.Models.Users.EmailConfirmationCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Perfum.Domain.Models.Users.PasswordResetCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Perfum.Domain.Models.Users.EmailConfirmationCode", b =>
                {
                    b.HasOne("Perfum.Domain.Models.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
