...
const defs = [
...

    {
        ...
        dir: 'up',
        color: 'var(--green)',
        spark: [10, 14, 18, 16, 22, 20, 28, 26, 32, 30, 38, 42]
    },

    {
        ...
        dir: 'up',
        color: 'var(--purple)',
        spark: [30, 28, 32, 34, 30, 36, 32, 38, 36, 40, 38, 44]
    },

    {
        ...
        dir: 'up',
        color: 'var(--gold)',
        spark: [20, 22, 19, 25, 23, 28, 26, 30, 28, 32, 30, 36]
    },
...
<div class="kpi-icon"
style="background:linear-gradient(135deg,${k.color}22,${k.color}09);color:${k.color}">
    ${k.icon}
</div>
...
<div class="kpi-spark">
    ...
    background:${k.color};
    opacity:${0.3 + v / maxSpark * .7};
    animation-delay:${j * .03}s"></div>`).join('')}
</div>
